    ...
    <section id="hubspotacademy" className="py-5">
      <div className="container">
          ...
          <div className="col-sm-6 col-xs-12 content-left">
            <div className="sbstpimg">
              <a
                ...
                target="_blank"
              >
                <Image alt="HubSpot Academy Solution Partner" src={logo5} />
                <div className="hub-certificate">
                <h3>Hubspot Academy</h3>
                <p><strong>Solutions Partner Certified</strong></p>
        ...
        <div className="row">
         ...
         <div className="explrbtnsct"><Link href="/contact-us" className="explore-btn">
                Hire Now!
              </Link></div>
          </div>
        </div>
