                ...
                <div className="col-lg-3">
                  <div className="location-tabs">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li
                        className={`hover-tabs ${lastHoveredLocation === "India" ? "active-loc" : ""}`}
                      ...
                      <li
                        className={`hover-tabs ${lastHoveredLocation === "Australia" ? "active-loc" : ""}`}
                      ...
                      <li
                        className={`hover-tabs ${lastHoveredLocation === "USA" ? "active-loc" : ""}`}
                      ...
                      <li
                        className={`hover-tabs ${lastHoveredLocation === "UK" ? "active-loc" : ""}`}
